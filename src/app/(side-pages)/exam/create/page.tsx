...
import { createExam } from "@/utils/api/admin";
...
export default function ExamCreator() {
  ...
  const { mutate: createExamMutation, isPending: isSubmitting } = useMutation({
    mutationKey: ["exams"],
  ...
  const handleCreateExam = async () => {
    ...
    const formattedData = {
      ...
      exercises: examData.exercises.map((ex, index) => ({
        ...
        // alternatives: ex.alternatives?.map((alternative) => ({letter: "", value: alternative.value}))
      })),
      substitute_exercises: examData.substitute_exercises.map((ex, index) => ({
        ...ex,
    ...
    createExamMutation(formattedData);
  };
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold">Criar Prova</h1>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Select
                ...
                onValueChange={(value: ExamCategoryType) =>
                  setExamData((prev) => ({ ...prev, category: value }))
                }
              >
                <SelectTrigger>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Input
                ...
                onChange={(e) => {
                  ...
                  setExamData((prev) => ({ ...prev, ends_at: newEnd }));
                }}
              />
            </div>
          </div>
          ...
          <div className="flex items-center space-x-2">
            <Switch
              ...
              onCheckedChange={(checked) =>
                setExamData((prev) => ({ ...prev, hidden: checked }))
              }
            />
